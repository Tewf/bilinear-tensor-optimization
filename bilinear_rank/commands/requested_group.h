...
///
/// It sits beside the commands rather than inside the library because this is
/// the point where a word typed at a shell becomes a group, and the library has
/// no business knowing that a command line exists. All three commands that take
/// the flag are in this directory, so this is also as deep as it can go.
