...
[`exhaustive_search.h`](exhaustive_search.h). Source: Covanov, *Multiplication
...
Prop. 2.6). [`candidate_pool.h`](candidate_pool.h) already says its
...
[`known_ranks.md`](known_ranks.md), that run now reproduces a published
