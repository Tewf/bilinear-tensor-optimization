...
PLinOpt is Jean-Guillaume Dumas's own toolchain for exactly these operators, so
SMS is not a convenience here. It is the interface to the person supervising the
work, and every disagreement about it is a disagreement about whether the two
sides can exchange anything at all. Both directions have been run against his
binaries, built from source and installed nowhere.
...
[`../internship_heuristic/commands/minimise_rank_main.cpp`](../internship_heuristic/commands/minimise_rank_main.cpp).
