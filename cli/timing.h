...
///
/// A steady clock, not a wall clock: these numbers are compared against the
/// internship's timings, and a clock that can step backwards would make a
/// search look faster than it ran.
