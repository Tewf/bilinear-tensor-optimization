...
/// of rank-one maps for 4x4 matrix multiplication is `(2^16 - 1)^2` matrices,
/// about **720 GB**: as a `reserve` it is an instant kill, and the caller has no
/// way to find that out other than by dying. The span in step 1 grows the same
/// way, `p^slices`.
///
